...
function Services() {
  ...
  const services = [
    { name: 'Initial Consultation', duration: 60, price: 150, desc: 'A comprehensive first visit to assess your condition and create a personalized treatment plan.', icon: '🩺' },
    { name: 'Sports Massage', duration: 45, price: 120, desc: 'Deep tissue sports massage targeting muscle tension and aiding in sports injury recovery.', icon: '💪' },
    { name: 'Electrotherapy', duration: 30, price: 100, desc: 'Pain relief and muscle stimulation using safe electrical currents for faster recovery.', icon: '💡' },
    { name: 'Manual Therapy', duration: 60, price: 180, desc: 'Hands-on joint and muscle manipulation to restore mobility and reduce pain.', icon: '🤲' },
    { name: 'Ultrasound Therapy', duration: 30, price: 90, desc: 'Therapeutic ultrasound to promote tissue healing and reduce inflammation.', icon: '🔊' },
    { name: 'Pediatric Physiotherapy', duration: 45, price: 130, desc: 'Gentle, specialized physiotherapy for children and adolescents.', icon: '🌱' },
  ]
