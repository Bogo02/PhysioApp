    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ color: '#1a3a1a', margin: '0 0 0.5rem', fontSize: '1.8rem', fontWeight: '800' }}>Create Account</h2>
          <p style={{ color: '#888', margin: '0 0 1.5rem', fontSize: '0.9rem' }}>Join AFYMO and start your recovery journey</p>
          ...
          <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div style={{ display: 'flex', gap: '1rem' }}>
              <div style={{ flex: 1 }}>
                ...
                <input type="text" value={firstName} onChange={e => setFirstName(e.target.value)}
                  placeholder="Ion"
                  style={{ width: '100%', padding: '0.65rem 1rem', borderRadius: '8px', border: '1.5px solid #e2e8f0', fontFamily: 'inherit', fontSize: '0.9rem', boxSizing: 'border-box', outline: 'none' }} />
              </div>
              <div style={{ flex: 1 }}>
            ...
            <div>
              <label style={{ color: '#444', fontSize: '0.85rem', fontWeight: '600', display: 'block', marginBottom: '0.4rem' }}>Role</label>
          ...
          <p style={{ textAlign: 'center', marginTop: '1.5rem', color: '#888', fontSize: '0.9rem' }}>
            ...
            <span onClick={() => navigate('/login')} style={{ color: '#2d6a2d', fontWeight: '600', cursor: 'pointer' }}>Login</span>
          </p>
        </div>
      </div>
    </div>
