      ...
      <div style={{ padding: '3rem 4rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '3rem' }}>
          <div onClick={() => navigate('/appointments')} style={{
            background: '#2d6a2d', color: 'white', padding: '1.5rem 2rem',
            borderRadius: '16px', cursor: 'pointer', minWidth: '180px',
            boxShadow: '0 4px 16px rgba(45,106,45,0.2)'
          }}>
            <h3 style={{ margin: 0, fontSize: '1rem' }}>📅 My Appointments</h3>
            <p style={{ margin: '0.4rem 0 0', fontSize: '0.85rem', opacity: 0.8 }}>View and manage</p>
          </div>

          <div onClick={() => navigate('/appointments/book')} style={{
            background: '#1a3a1a', color: 'white', padding: '1.5rem 2rem',
            borderRadius: '16px', cursor: 'pointer', minWidth: '180px',
            boxShadow: '0 4px 16px rgba(26,58,26,0.2)'
          }}>
            <h3 style={{ margin: 0, fontSize: '1rem' }}>➕ Book Appointment</h3>
            <p style={{ margin: '0.4rem 0 0', fontSize: '0.85rem', opacity: 0.8 }}>Schedule a new visit</p>
          </div>

          <div onClick={() => navigate('/profile')} style={{
            background: '#3d8b3d', color: 'white', padding: '1.5rem 2rem',
            borderRadius: '16px', cursor: 'pointer', minWidth: '180px',
            boxShadow: '0 4px 16px rgba(61,139,61,0.2)'
          }}>
            <h3 style={{ margin: 0, fontSize: '1rem' }}>👤 My Profile</h3>
            <p style={{ margin: '0.4rem 0 0', fontSize: '0.85rem', opacity: 0.8 }}>View account details</p>
          </div>
          ...
          {appointments.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '2rem', color: '#888' }}>
              ...
              <button onClick={() => navigate('/appointments/book')} style={{
                ...
                fontWeight: '700', marginTop: '1rem', fontFamily: 'inherit'
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {appointments.map(a => (
                <div key={a.id} style={{
                  background: 'white', border: '1px solid rgba(45,106,45,0.1)',
