  ...
  return (
    <div>
      <nav style={{
        ...
        <h2 style={{ margin: 0, cursor: 'pointer' }} onClick={() => navigate('/')}>Cabinet Marcel</h2>
      ...
      <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
        <h1 style={{ color: '#1a3a6b', textAlign: 'center' }}>Our Services</h1>
        ...
        <div style={{ textAlign: 'center', marginTop: '2rem' }}>
          <button onClick={() => navigate('/register')} style={{
            padding: '0.75rem 2rem', background: '#1a3a6b', color: 'white',
